...
// DO NOT CHANGE
    ...
    // Control signals generated via combinational logic in the controller
    // these continuously assigned values are fed to the datapath 
   ...
   datapath #(.Nreg(Nreg), .Dbits(Dbits)) dp(
      .clk(clk), 
      .reset(reset), 
      .enable(enable),
      .pc(pc), 
